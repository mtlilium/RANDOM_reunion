...
<tileset version="1.2" tiledversion="1.2.2" name="water" tilewidth="64" tileheight="64" tilecount="16" columns="4">
 <image source="../dot/export/map/water.png" width="256" height="256"/>
 <terraintypes>
